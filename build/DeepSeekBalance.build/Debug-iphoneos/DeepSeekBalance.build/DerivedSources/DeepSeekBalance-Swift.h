...
#ifndef DEEPSEEKBALANCE_SWIFT_H
#define DEEPSEEKBALANCE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DeepSeekBalance",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15DeepSeekBalance11AgentServer") SWIFT_AVAILABILITY(ios,introduced=17.0)
